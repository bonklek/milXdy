...
export function extractReadablePost(tweet: HTMLElement, settings: PostreaderSettings): ReadablePost | null {
...
export function formatReadablePost(post: ReadablePost, settings: PostreaderSettings): string {
