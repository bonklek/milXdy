...
export const MILXDY_ADDONS_CATALOG_FALLBACK_URL = "https://github.com/bonklek/milXdy/blob/main/docs/APP_SDK.md#future-github-app-store-path";
export const MILXDY_ADDONS_CATALOG_URL_RULES: readonly UrlAllowRule[] = [
  ...
  { origin: "https://github.com", pathPrefix: "/bonklek/milXdy/blob/main/docs/APP_SDK.md" },
];
