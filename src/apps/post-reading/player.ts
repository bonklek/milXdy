...
import type { OverlayAppFrame } from "../../platform/overlay/app-frame";
import { animateOverlayAppClose, animateOverlayAppOpen, ensureOverlayAppChromeStyles, markOverlayAppLayoutReady, prepareOverlayAppRoot } from "../../platform/overlay/app-chrome";
...
export class MiniPlayer {
  ...
  updateOcrStatus(progress: OcrProgress | null): void {
    ...
    if (!this.minimized && !this.closing) this.setVisible(true);
  }
  ...
  private renderSettings(): void {
    ...
    const fullQuotes = checkbox("Fetch full quoted posts from public sources", this.settings.fetchFullQuotes, (checked) => this.update({ fetchFullQuotes: checked }));
