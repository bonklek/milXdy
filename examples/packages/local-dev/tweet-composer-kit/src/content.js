...
export async function onComposerAction({ panel, externalHandoffs, launchExternalHandoff, queryRemoteService, signal }) {
...
function buildContributionHandoff({ signal }) {
  ...
  rights.addEventListener("change", () => { status.textContent = ""; }, { signal });
  root.append(
