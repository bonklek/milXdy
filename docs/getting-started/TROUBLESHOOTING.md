...
- **Pets Maker cannot fetch traits**: confirm the selected family and NFT number are within the visible range and that `https://maker.remilia.org` is reachable. Fetch uses public metadata only; you can keep the form open and enter the visible traits manually.
