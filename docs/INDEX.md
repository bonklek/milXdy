# milXdy documentation

## Start here

- [Install and update](getting-started/INSTALL_AND_UPDATE.md)
- [User guide](guides/README.md)
- [Troubleshooting](getting-started/TROUBLESHOOTING.md)
- [Privacy and permissions](getting-started/PRIVACY_AND_PERMISSIONS.md)
...
- [Custom Pet integrated QA (planned 0.2.5)](guides/custom-pet-integrated-qa.md)
...
- [RemiNet Chat](guides/reminet-chat.md)
- [RemiStats](guides/remistats.md)
- [Root visual enhancements](guides/root-visual-enhancements.md)
- [Music](guides/music.md)
- [All feature guides](guides/README.md)
...
- [Author design guide candidate (planned 0.2.5)](../publication-candidates/milxdy-visual-elements/docs/AUTHOR_DESIGN_GUIDE.md)
...
- [Firefox and Waterfox](contributors/FIREFOX_QA.md)
- [Localization](contributors/LOCALIZATION.md)

## Project history and reference

- [Roadmap](roadmap/ROADMAP.md)
- [Identifier media post schema](roadmap/IDENTIFIER_MEDIA_POST_SCHEMA.md)
- [Custom Pet pipeline provenance (planned 0.2.5)](provenance/custom-pet-pipeline.md)
...
- [0.1.5 release notes](releases/RELEASE_NOTES_0.1.5.md)
- [0.1.4 release notes](releases/RELEASE_NOTES_0.1.4.md)
- [0.1.3 release notes](releases/RELEASE_NOTES_0.1.3.md)
- [0.1.2 release notes](releases/RELEASE_NOTES_0.1.2.md)
- [Post-reading standalone reference](reference/POST_READING_STANDALONE.md)
- [Max profile benchmark](reference/MAX_PROFILE_BENCHMARK.md)

For the complete release history, see the root [CHANGELOG](../CHANGELOG.md).
