...
function verifyInternalBridgeValidation() {
  ...
  requireIncludes(postReadingBackground, "fetch(message.url, { credentials: \"omit\" })", "post-reading background bridge must omit credentials for public full-quote fetches");
