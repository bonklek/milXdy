...
function verifyPlatformContract() {
  ...
  requireIncludes(contentRuntime, "Math.max(8, rect.bottom + window.scrollY + 8)", "Reply-action panels must remain document-anchored to their scrolling Reply control");
